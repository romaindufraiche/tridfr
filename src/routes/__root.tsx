...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Tri DFR" },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "Tri DFR" },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Archivo:wght@600;700;800;900&family=Barlow:wght@400;500;600&family=JetBrains+Mono:wght@500&display=swap",
      },
